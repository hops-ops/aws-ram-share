...
* chore: file-based env vars for e2e tests (#13) (by @patrickleet)
...
* feat(deps): update crossplane-contrib/function-auto-ready docker tag to v0.6.3 (#16) (by @renovate[bot])

  Co-authored-by: renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>


See full diff: [v0.9.0...v0.10.0](https://github.com/hops-ops/aws-ram-share/compare/v0.9.0...v0.10.0)
